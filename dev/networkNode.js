...
app.post('/transaction', function (req, res) {
    const blockIndex = edcoin.createNewTransaction(req.body.amount, req.body.sender, req.body.recipient);
...
app.get('/mine', function (req, res) {
    ...
    const blockHash = edcoin.hashBlock(previousBlockHash, currentBLockData, nonce);
